...
//        });
        ...
        if (savedInstanceState == null && findViewById(R.id.main_content) != null) {
            ResourceListFragment listFragment = new ResourceListFragment();
            getSupportFragmentManager().beginTransaction().add(R.id.main_content, listFragment).commit();
        }
    }
